...
SET PrfVCCS=TeamSpeakVccs	Ts3NickName	%CID%
...
echo %PrfVCCS%>>"Belfast/Aldergrove SMR.prf"
...
echo %PrfVCCS%>>"Birmingham/Birmingham ATM.prf"
...
echo %PrfVCCS%>>"Birmingham/Birmingham Combined.prf"
...
echo %PrfVCCS%>>"East Midlands/East Midlands APP.prf"
...
echo %PrfVCCS%>>"East Midlands/East Midlands ATM.prf"
...
echo %PrfVCCS%>>"East Midlands/East Midlands SMR.prf"
...
echo %PrfVCCS%>>"Exeter/Exeter Combined.prf"
...
echo %PrfVCCS%>>"Generic/Generic APP.prf"
...
echo %PrfVCCS%>>"Liverpool/Liverpool APP.prf"
...
echo %PrfVCCS%>>"Liverpool/Liverpool ATM.prf"
...
echo %PrfVCCS%>>"Liverpool/Liverpool Combined.prf"
...
echo %PrfVCCS%>>"Liverpool/Liverpool SMR.prf"
...
echo %PrfVCCS%>>"London Control/AC - Default/Bandbox.prf"
...
echo %PrfVCCS%>>"London Control/AC - Default/Central.prf"
...
echo %PrfVCCS%>>"London Control/AC - Default/North.prf"
...
echo %PrfVCCS%>>"London Control/AC - Default/South Central.prf"
...
echo %PrfVCCS%>>"London Control/AC - Default/South.prf"
...
echo %PrfVCCS%>>"London Control/AC - Default/West.prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/Bandbox (TopSky).prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/Bandbox.prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/Central (TopSky).prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/Central.prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/North (TopSky).prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/North.prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/South (TopSky).prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/South Central (TopSky).prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/South Central.prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/South.prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/West (TopSky).prf"
...
echo %PrfVCCS%>>"London Control/AC - NERC/West.prf"
...
echo %PrfVCCS%>>"London Control/LTC/TC Bandbox.prf"
...
echo %PrfVCCS%>>"London Control/LTC/TC North.prf"
...
echo %PrfVCCS%>>"London Control/LTC/TC South.prf"
...
echo %PrfVCCS%>>"Manchester/Manchester APP.prf"
...
echo %PrfVCCS%>>"Manchester/Manchester ATM.prf"
...
echo %PrfVCCS%>>"Manchester/Manchester Combined.prf"
...
echo %PrfVCCS%>>"Manchester/Manchester SMR.prf"
...
echo %PrfVCCS%>>"Newcastle/Newcastle APP.prf"
...
echo %PrfVCCS%>>"Newcastle/Newcastle Combined.prf"
...
echo %PrfVCCS%>>"Newcastle/Newcastle SMR.prf"
...
echo %PrfVCCS%>>"Oxford/Oxford Combined.prf"
